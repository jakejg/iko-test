!(function (e, t) {
      ...
      var s = function () {
        T()
          ...
          : (new Promise(function (e) {
              ...
              (ae.restoreFocusTimeout = setTimeout(function () {
                ae.previousActiveElement && ae.previousActiveElement.focus
                  ? (ae.previousActiveElement.focus(), (ae.previousActiveElement = null))
            ...
            ae.keydownTarget.removeEventListener('keydown', ae.keydownHandler, { capture: ae.keydownListenerCapture }),
          ...
          E() &&
            ...
            'undefined' != typeof window && he() && window.removeEventListener('resize', ve),
  ...
  var Ce = function e(t, n) {
    ...
    ke = {
      ...
      url: function (e, t) {
        return /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(e)
          ? Promise.resolve()
  ...
  var Be = function (e) {
    ...
    null !== e.onBeforeOpen && 'function' == typeof e.onBeforeOpen && e.onBeforeOpen(n),
      ...
      E() &&
        ...
        'undefined' != typeof window && he() && (ve(), window.addEventListener('resize', ve)),
        p(document.body.children).forEach(function (e) {
          e === v() ||
            (function (e, t) {
      ...
      T() || ae.previousActiveElement || (ae.previousActiveElement = document.activeElement),
      null !== e.onOpen &&
  ...
  var xe,
    Ae = Object.freeze({
      ...
      _main: function (e) {
        ...
        !(function (e) {
          for (var t in e)
            le(t) || q('Unknown parameter "'.concat(t, '"')),
              e.toast && -1 !== ue.indexOf(t) && q('The parameter "'.concat(t, '" is incompatible with toasts')),
              de(t) &&
                ((n = 'The parameter "'.concat(t, '" is deprecated and will be removed in the next major release.')),
        ...
        !(function (t) {
          ...
          (e = n && o && n.parentNode !== o.parentNode ? Y(t) : n || Y(t)),
          ...
          if (
            ...
            t.position in I
              ? D(s, I[t.position])
              : (q('The "position" parameter is not valid, defaulting to "center"'), D(s, I.center)),
          ...
          t.showCloseButton ? (c.setAttribute('aria-label', t.closeButtonAriaLabel), z(c)) : W(c),
            (e.className = I.popup),
            t.toast ? (D([document.documentElement, document.body], I['toast-shown']), D(e, I.toast)) : D(e, I.modal),
        ...
        return new Promise(function (e) {
          ...
          be.swalPromiseResolve.set(E, e),
            T.timer &&
              (ae.timeout = new Ce(function () {
          ...
          for (
            ...
            (o[i].onclick = t), (o[i].onmouseover = t), (o[i].onmouseout = t), (o[i].onmousedown = t);
          if (
          ...
          var a = function (e, t) {
            for (var n = Q(T.focusCancel), o = 0; o < n.length; o++)
              return (e += t) === n.length ? (e = 0) : -1 === e && (e = n.length - 1), n[e].focus();
            O.popup.focus();
          };
          ae.keydownHandlerAdded &&
            (ae.keydownTarget.removeEventListener('keydown', ae.keydownHandler, { capture: ae.keydownListenerCapture }),
            (ae.keydownHandlerAdded = !1)),
            T.toast ||
              ((ae.keydownHandler = function (e) {
                return (function (e, t) {
                    ...
                    if ('Tab' === e.key) {
                      ...
                      ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'Left', 'Right', 'Up', 'Down'].indexOf(e.key)
                        ? document.activeElement === O.confirmButton && K(O.cancelButton)
                          ...
                          : document.activeElement === O.cancelButton && K(O.confirmButton) && O.confirmButton.focus()
              ...
              (ae.keydownTarget = T.keydownListenerCapture ? window : O.popup),
              (ae.keydownListenerCapture = T.keydownListenerCapture),
              ae.keydownTarget.addEventListener('keydown', ae.keydownHandler, { capture: ae.keydownListenerCapture }),
              (ae.keydownHandlerAdded = !0)),
            E.enableButtons(),
            E.hideLoading(),
            E.resetValidationMessage(),
          ...
          if ('select' === T.input || 'radio' === T.input) {
            ...
            R(T.inputOptions)
              ...
              ? L(T.inputOptions)
              : H('Unexpected type of inputOptions! Expected object, Map or Promise, got '.concat(V(T.inputOptions)));
          } else
