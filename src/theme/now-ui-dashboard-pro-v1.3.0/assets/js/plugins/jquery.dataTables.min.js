...
(function (h) {
  ...
  n.ext = x = {
    buttons: {},
    classes: {},
    build: 'bs4/dt-1.10.18/cr-1.5.0/fc-3.2.5/fh-3.1.4/r-2.2.2/rg-1.1.0/rr-1.2.4/sc-1.5.0/sl-1.2.6',
    errMode: 'alert',
    feature: [],
    search: [],
...
(function (e) {
  ...
  e.fn.dataTableExt.oApi.fnColReorder = function (a, b, c, f, g) {
    ...
    if (b != c)
      if (0 > b || b >= l) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b);
      else if (0 > c || c >= l) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + c);
      else {
        j = [];
        d = 0;
        for (h = l; d < h; d++) j[d] = d;
          ...
          (k = a.aoColumns[d]),
            'number' == typeof k.mData
              ...
              : e.isPlainObject(k.mData) &&
                (i(k.mData, '_', n), i(k.mData, 'filter', n), i(k.mData, 'sort', n), i(k.mData, 'type', n));
        ...
        e(a.oInstance).trigger('column-reorder.dt', [
          a,
          { from: b, to: c, mapping: n, drop: f, iFrom: b, iTo: c, aiInvertMapping: n },
        ]);
      }
  };
  var i = function (a, b) {
  ...
  e.extend(i.prototype, {
    ...
    _fnMouseMove: function (a) {
      ...
      for (var b = !1, c = this.s.mouse.toIndex, f = 1, e = this.s.aoTargets.length; f < e; f++)
        if (
          ...
          this.s.aoTargets[f - 1].x + (this.s.aoTargets[f].x - this.s.aoTargets[f - 1].x) / 2
        ) {
    ...
    _fnRegions: function () {
      ...
      for (var b = 0, c = this.s.aoTargets[0].x, f = 0, g = a.length; f < g; f++)
        f != this.s.mouse.fromIndex && b++,
          a[f].bVisible &&
            'none' !== a[f].nTh.style.display &&
            ((c += e(a[f].nTh).outerWidth()), this.s.aoTargets.push({ x: c, to: b }));
      ...
      var c = this.s.dt.nTable.parentNode.offsetHeight,
        ...
        j = function (b, c) {
          f.bar
            ...
            : ((b.style.width = c + 20 + 'px'), (b.style.paddingRight = '20px'), (b.style.boxSizing = 'border-box'));
        };
      f.x && (c -= f.bar);
    ...
    if (a.parents('.DTFC_Cloned').length) {
      var b = a.parent().index(),
        ...
        a = a.parents('.DTFC_LeftWrapper').length
          ? a.index()
          : this.columns().flatten().length - this.context[0]._oFixedColumns.s.iRightColumns + a.index();
...
(function (a) {
  ...
  a.extend(h.prototype, {
    ...
    _rowWrap: function (b, g, c) {
      ...
      return b === e
        ? null
        : ('object' === typeof b && b.nodeName && 'tr' === b.nodeName.toLowerCase()
            ? a(b)
            : b instanceof a && b.length && 'tr' === b[0].nodeName.toLowerCase()
            ? b
            : a('<tr/>').append(a('<td/>').attr('colspan', this._colspan()).append(b))
          )
      ...
      d(b.table().container()).on('mousedown.rowReorder touchstart.rowReorder', this.c.selector, function (a) {
        if (c.c.enable) {
          ...
          var i = d(this).closest('tr'),
            j = b.row(i);
          if (j.any())
            return c._emitEvent('pre-row-reorder', { node: j.node(), index: j.index() }), c._mouseDown(a, i), !1;
        }
      });
      ...
      if (null === this.s.lastInsert || this.s.lastInsert !== e)
        0 === e
          ...
          : ((b = d.unique(i.rows({ page: 'current' }).nodes().toArray())),
            e > this.s.lastInsert ? this.dom.target.insertAfter(b[e - 1]) : this.dom.target.insertBefore(b[e])),
          this._cachePositions(),
          (this.s.lastInsert = e);
      this._shiftScroll(c);
    },
...
(function (e) {
  ...
  e.extend(g.prototype, {
    ...
    _fnDrawCallback: function () {
      ...
      this.s.skip = !0;
      if ((this.s.dt.bSorted || this.s.dt.bFiltered) && 0 === f) this.s.topRowFloat = 0;
      c =
        0 === f
        ...
        var a = this.s.dt,
          ...
          h =
            0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal()
              ...
              ? b.sInfo.replace('_START_', h).replace('_END_', i).replace('_MAX_', k).replace('_TOTAL_', l) +
                b.sInfoPostFix
              : b.sInfo.replace('_START_', h).replace('_END_', i).replace('_MAX_', k).replace('_TOTAL_', l) +
                ' ' +
